<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="MusicanList.aspx.cs" Inherits="_Default" %>
...
(SELECT A.ID_NUMBER 
FROM ALBUM A
WHERE A.COPY_RIGHT_DATE IS NULL);"></asp:SqlDataSource>
</asp:Content>
